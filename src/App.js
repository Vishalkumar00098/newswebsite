...
const App = () => {
  const apiKey = 'f4641e4ba75c48b8b77abcb16a688d80';
      ...
      <div>
        <Router>
          ...
          <Routes>
            ...
            <Route exact path="/entertainment" ele ment={<News setProgress={setProgress} apiKey={apiKey} key="entertainment" pageSize={5} country="in" category="entertainment" />}></Route>
